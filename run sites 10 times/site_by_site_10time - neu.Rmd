...
Selected <- sample.int(nrow(obs_4[[2]][[1]]),floor(365*0.5*df_drivers2[1,]$params_siml[[1]]$nyeartrend))
obs_4[[2]][[1]][-Selected,]$le <- NA


pars <- calib_sofun(
    drivers = df_drivers2[1,],  
    obs = obs_4,
    settings = settings
  )
c_neu<-tibble()
